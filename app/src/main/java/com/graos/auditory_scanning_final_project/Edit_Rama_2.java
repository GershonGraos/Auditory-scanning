...
public class Edit_Rama_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit__rama_2);
        setTitle(R.string.nameActivity_edit_pattient);

        my_db_requests = new DBHelper_Requests(this);

        _my_lastClick_item = (TextView) findViewById(R.id.textView_request_click);
        _request = (EditText) findViewById(R.id.editText_request);
        _my_list_view = (ListView) findViewById(R.id.listItems_Rama2);
        ...
        _my_list_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i;
                i = new Intent(Edit_Rama_2.this, Edit_Rama_3.class);
        ...
        _my_list_view.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long l){
                request_click = (String)_my_list_view.getItemAtPosition(position);
                View view1 = LayoutInflater.from(Edit_Rama_2.this).inflate(R.layout.edit_or_delete_request, null);
                final AlertDialog.Builder builder_buttons = new AlertDialog.Builder(Edit_Rama_2.this);
    ...
    // ------------------------ PRIVATE FUNCTIONS ---------------------------------------
    // ADD REQUEST TO DB
    public void press_addItem_Rama2(View view){
        ...
        if(!request_now.equals("")){
            ...
            if(flag == 0){
                long temp = my_db_requests.add_request(id_patient, i_parent, "2", request_now, getDateTime(), count);
                if (temp == -1)
    ...
    public void populateListViews(){
        Cursor cursor = my_db_requests.show_requests_level_2_3_4(id_patient, i_parent, "2");
    ...
    public void button_edit_request(View view){
        final AlertDialog.Builder builder = new AlertDialog.Builder(Edit_Rama_2.this);
        builder.setTitle(R.string.edit_tittle);
        builder.setIcon(R.mipmap.ic_edit_req);
        a = new EditText(Edit_Rama_2.this);
        builder.setView(a);
                        ...
                        if( !in.equals("")){
                            ...
                            while(cursor.moveToNext()) {
                                if(cursor.getString(3).equals(request_click)){
                                    ...
                                    if(edit_row == true){
                                        populateListViews();
                                        Toast.makeText(Edit_Rama_2.this, R.string.edit_successfully, Toast.LENGTH_SHORT).show();
                                    }
                                    else
                                        Toast.makeText(Edit_Rama_2.this, R.string.edit_not_successfully, Toast.LENGTH_SHORT).show();
                                    break;
                                }
                            }
                        }
                        else
                            Toast.makeText(Edit_Rama_2.this, R.string.edit_enter_request, Toast.LENGTH_SHORT).show();
                    }
                })
