...
public class Display_Rama_2 extends AppCompatActivity {
    ...
    public void populateListViews(){
        ...
        if(mApp.statistic_sort)
            cursor = my_db_requests.show_requests_level_2_3_4_sorted_statistically(id_patient,i_parent,"2");
        else
            cursor = my_db_requests.show_requests_level_2_3_4(id_patient,i_parent,"2");
