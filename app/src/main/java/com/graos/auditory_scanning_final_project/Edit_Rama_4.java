...
public class Edit_Rama_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit__rama_4);
        ...
        _my_lastClick_item = (TextView) findViewById(R.id.textView_request_click_rama4);
        _request = (EditText) findViewById(R.id.editText_request_rama4);
        _my_list_view = (ListView) findViewById(R.id.listItems_Rama4);

        Intent i;
        i = getIntent();
        lastClick_request = i.getStringExtra("THE_REQUEST_TO_4");
        id_patient = i.getStringExtra("ID_PT_TO_4");
        i_parent = i.getStringExtra("MY_I_PARENT_TO_4");
        ...
        _my_list_view.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long l){
                ...
                View view1 = LayoutInflater.from(Edit_Rama_4.this).inflate(R.layout.edit_or_delete_request, null);
                final AlertDialog.Builder builder_buttons = new AlertDialog.Builder(Edit_Rama_4.this);
    ...
    // ------------------------ PRIVATE FUNCTIONS ---------------------------------------
    // ADD REQUEST TO DB
    public void press_addItem_Rama4(View view){
        ...
        if(!request_now.equals("")){
            ...
            if(flag == 0){
                long temp = my_db_requests.add_request(id_patient, i_parent, "4", request_now, getDateTime(), count);
                if (temp == -1)
    ...
    public void populateListViews(){
        Cursor cursor = my_db_requests.show_requests_level_2_3_4(id_patient, i_parent, "4");
    ...
    public void button_edit_request(View view){
        final AlertDialog.Builder builder = new AlertDialog.Builder(Edit_Rama_4.this);
        builder.setTitle(R.string.edit_tittle);
        builder.setIcon(R.mipmap.ic_edit_req);
        a = new EditText(Edit_Rama_4.this);
        builder.setView(a);
                        ...
                        if( !in.equals("")){
                            ...
                            while(cursor.moveToNext()) {
                                if(cursor.getString(3).equals(request_click)){
                                    ...
                                    if(edit_row == true){
                                        populateListViews();
                                        Toast.makeText(Edit_Rama_4.this, R.string.edit_successfully, Toast.LENGTH_SHORT).show();
                                    }
                                    else
                                        Toast.makeText(Edit_Rama_4.this, R.string.edit_not_successfully, Toast.LENGTH_SHORT).show();
                                    break;
                                }
                            }
                        }
                        else
                            Toast.makeText(Edit_Rama_4.this, R.string.edit_enter_request, Toast.LENGTH_SHORT).show();
                    }
                })
